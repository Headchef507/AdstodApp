...
public class TheQuestion implements Iterator<TheQuestion> {
 ...
 */
   ...
   // public class Question implements Iterator<Question> {
        ...
        public TheQuestion(long id, String questionText, String[] answerOptions, int answer){
            this.id = id;
